...
(declare-fun i_6 () Value)
(declare-fun i_7 () Value)
(declare-fun i_8 () Value)
(declare-fun i_9 () Value)
...
(declare-fun o_6 () Value :no_dependence)
(declare-fun o_7 () Value :no_dependence)
(declare-fun o_8 () Value :no_dependence)
(declare-fun o_9 () Value :no_dependence)
...
(declare-fun c_6 () Control)
(declare-fun c_7 () Control)
(declare-fun c_8 () Control)
(declare-fun c_9 () Control)
  ...
  (=>
    (and
      (and ; pos/neg properties
        ...
        (xor (pos i_6) (pos (neg i_6)))
        (xor (pos i_7) (pos (neg i_7)))
        (xor (pos i_8) (pos (neg i_8)))
        (xor (pos i_8) (pos (neg i_9)))
      )
      (and ; update
        (ite
          c_1
