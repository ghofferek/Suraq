...
(define-fun step  ((pc1 Value)(pc1_n Value)(pc2 Value)(pc2_n Value)(MEM (Array Value Value))(MEM_n (Array Value Value))
                   ...
                   (c_unlock1 Bool) (c_unlock2 Bool)) Bool 
...
(define-fun parallel 
 ( (pc1_0 Value) (pc1_1 Value) (pc1_2 Value) (pc1_3  Value) (pc1_4 Value) (pc1_5 Value) (pc1_6 Value) (pc1_7 Value) (pc1_8 Value) (pc1_9 Value) (pc1_10  Value) (pc1_11 Value) (pc1_12 Value) 
   ...
   (c_unlock1 Bool) (c_unlock2 Bool) 
) Bool
  (and
    (step pc1_0 pc1_1 pc2_0 pc2_1 MEM   MEM_1 tmp11_0 tmp11_1 tmp12_0 tmp12_1 tmp21_0 tmp21_1 tmp22_0 tmp22_1 idx1 idx2 idx3 idx4 lock_0 lock_1 c_unlock1 c_unlock2)
    (step pc1_1 pc1_2 pc2_1 pc2_2 MEM_1 MEM_2 tmp11_1 tmp11_2 tmp12_1 tmp12_2 tmp21_1 tmp21_2 tmp22_1 tmp22_2 idx1 idx2 idx3 idx4 lock_1 lock_2 c_unlock1 c_unlock2)
    (step pc1_2 pc1_3 pc2_2 pc2_3 MEM_2 MEM_3 tmp11_2 tmp11_3 tmp12_2 tmp12_3 tmp21_2 tmp21_3 tmp22_2 tmp22_3 idx1 idx2 idx3 idx4 lock_2 lock_3 c_unlock1 c_unlock2)
    (step pc1_3 pc1_4 pc2_3 pc2_4 MEM_3 MEM_4 tmp11_3 tmp11_4 tmp12_3 tmp12_4 tmp21_3 tmp21_4 tmp22_3 tmp22_4 idx1 idx2 idx3 idx4 lock_3 lock_4 c_unlock1 c_unlock2)
    (step pc1_4 pc1_5 pc2_4 pc2_5 MEM_4 MEM_5 tmp11_4 tmp11_5 tmp12_4 tmp12_5 tmp21_4 tmp21_5 tmp22_4 tmp22_5 idx1 idx2 idx3 idx4 lock_4 lock_5 c_unlock1 c_unlock2)
    (step pc1_5 pc1_6 pc2_5 pc2_6 MEM_5 MEM_6 tmp11_5 tmp11_6 tmp12_5 tmp12_6 tmp21_5 tmp21_6 tmp22_5 tmp22_6 idx1 idx2 idx3 idx4 lock_5 lock_6 c_unlock1 c_unlock2)
        
    (step pc1_6  pc1_7  pc2_6  pc2_7  MEM_6  MEM_7  tmp11_6  tmp11_7  tmp12_6  tmp12_7  tmp21_6  tmp21_7  tmp22_6  tmp22_7  idx1 idx2 idx3 idx4 lock_6  lock_7  c_unlock1 c_unlock2)
    (step pc1_7  pc1_8  pc2_7  pc2_8  MEM_7  MEM_8  tmp11_7  tmp11_8  tmp12_7  tmp12_8  tmp21_7  tmp21_8  tmp22_7  tmp22_8  idx1 idx2 idx3 idx4 lock_7  lock_8  c_unlock1 c_unlock2)
    (step pc1_8  pc1_9  pc2_8  pc2_9  MEM_8  MEM_9  tmp11_8  tmp11_9  tmp12_8  tmp12_9  tmp21_8  tmp21_9  tmp22_8  tmp22_9  idx1 idx2 idx3 idx4 lock_8  lock_9  c_unlock1 c_unlock2)
    (step pc1_9  pc1_10 pc2_9  pc2_10 MEM_9  MEM_10 tmp11_9  tmp11_10 tmp12_9  tmp12_10 tmp21_9  tmp21_10 tmp22_9  tmp22_10 idx1 idx2 idx3 idx4 lock_9  lock_10 c_unlock1 c_unlock2) 
    (step pc1_10 pc1_11 pc2_10 pc2_11 MEM_10 MEM_11 tmp11_10 tmp11_11 tmp12_10 tmp12_11 tmp21_10 tmp21_11 tmp22_10 tmp22_11 idx1 idx2 idx3 idx4 lock_10 lock_11 c_unlock1 c_unlock2)
    (step pc1_11 pc1_12 pc2_11 pc2_12 MEM_11 MEM_12 tmp11_11 tmp11_12 tmp12_11 tmp12_12 tmp21_11 tmp21_12 tmp22_11 tmp22_12 idx1 idx2 idx3 idx4 lock_11 lock_12 c_unlock1 c_unlock2)                       
  )     
)          
