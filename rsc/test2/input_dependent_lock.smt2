...
(declare-fun tmp_4_s () Value :no_dependence)

(declare-fun MEM_1_s () (Array Value Value) :no_dependence)
(declare-fun MEM_2_s () (Array Value Value) :no_dependence)
(declare-fun MEM_3_s () (Array Value Value) :no_dependence)
(declare-fun MEM_4_s () (Array Value Value) :no_dependence)

(declare-fun op  (Value) Value)

(define-fun distinct1 ( (ZERO Value) (ONE Value) (TWO Value) (THREE Value) (FOUR Value) (FIVE Value) (SIX Value)) Bool    
  ( and  
    (not (= ZERO ONE))
    (not (= ZERO TWO))
    (not (= ZERO THREE))
...
(define-fun select_index ( (index Value) (a Value) (b Value) (c Value) (d Value)) Bool    
  ( or  
...
;(T1.T2)
(define-fun sequential ( (tmp_1_s Value) (tmp_2_s Value) (tmp_3_s Value) (tmp_4_s Value)(MEM (Array Value Value)) (MEM_1_s (Array Value Value)) (MEM_2_s (Array Value Value)) (MEM_3_s (Array Value Value)) (MEM_4_s (Array Value Value)) 
  ...
  (and  
      ...
      (= MEM_2_s (store MEM idx2 tmp_1_s))
      
      (= tmp_3_s (op (select MEM_1_s idx3)))
      (= tmp_4_s (op (select MEM_1_s idx4)))
...
(define-fun phi 
 ( (pc1_0 Value) (pc1_1 Value) (pc1_2 Value) (pc1_3  Value) (pc1_4 Value) (pc1_5 Value) (pc1_6 Value) (pc1_7 Value) (pc1_8 Value) (pc1_9 Value) (pc1_10  Value) (pc1_11 Value) (pc1_12 Value) 
   ...
   (tmp_1_s Value) (tmp_2_s Value) (tmp_3_s Value) (tmp_4_s Value) (MEM_1_s (Array Value Value))(MEM_2_s (Array Value Value))(MEM_3_s (Array Value Value))(MEM_4_s(Array Value Value))   
 ) Bool
 (=>
  (and
      ;T1||T2
      ...
      (
         sequential tmp_1_s tmp_2_s tmp_3_s tmp_4_s MEM MEM_1_s MEM_2_s MEM_3_s MEM_4_s idx1 idx2 idx3 idx4    
      )           
  )  
  (  
     equiv MEM_12 MEM_4_s
   )   
 )
)
