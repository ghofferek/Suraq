...
public class GraphReductionTest {
    ...
    public void graphReduction2() {
        ...
        boolean result = testFile("./rsc/test/gr2.smt2",
                "./rsc/test/~gr2-reduced.smt2", "./rsc/test/~gr2-valid.smt2");
        System.out
                .println("  live: " + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    public void graphReduction3() {
        ...
        boolean result = testFile("./rsc/test/gr3.smt2",
                "./rsc/test/~gr3-reduced.smt2", "./rsc/test/~gr3-valid.smt2");
        System.out
                .println("  live: " + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    public void graphReduction4() {
        ...
        boolean result = testFile("./rsc/test/gr4.smt2",
                "./rsc/test/~gr4-reduced.smt2", "./rsc/test/~gr4-valid.smt2");
        System.out
                .println("  live: " + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    public void graphReductionMedium() {
        ...
        boolean result = testFile("./rsc/test/a07.smt2",
                "./rsc/test/~a07-reduced.smt2", "./rsc/test/~a07-valid.smt2");
        System.out
                .println("  live: " + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
