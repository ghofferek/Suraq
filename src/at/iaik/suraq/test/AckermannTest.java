...
public class AckermannTest {
    ...
    public void liveTest() {
        ...
        boolean result = testFile("./rsc/test/live.smt2",
                "./rsc/test/~live-acker.smt2", "./rsc/test/~live-unsat.smt2");
        System.out
    ...
    public void example0Test() {
        System.out
                .println("****************************************************");
        System.out.println("Testcase: Example 3.4 (pg. 66): "
                + "./rsc/test/ex34.smt2");
        boolean result = testFile("./rsc/test/ex34.smt2",
                "./rsc/test/~ex34-acker.smt2", "./rsc/test/~ex34-unsat.smt2");
        System.out.println("  Example 3.4 (pg. 66): "
                + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }

    // Ackermann Example aus dem Buch: 3.4 auf Seite 66 - mit AND statt OR ganz
    // aussen.
    @Test
    public void example1Test() {
        System.out
                .println("****************************************************");
        System.out.println("Testcase: Unsatisfiable with one function: "
                + "./rsc/test/a01.smt2");
        boolean result = testFile("./rsc/test/a01.smt2",
                "./rsc/test/~a01-acker.smt2", "./rsc/test/~a01-unsat.smt2");
        System.out.println("  Example 3.4 (pg. 66) mit AND statt OR: "
                + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }

    // Bsp erweitert um eine zusaetzliche Funktion
    @Test
    public void twoFunctions() {
        System.out
                .println("****************************************************");
        System.out.println("Testcase: 2 different Functions, unsatisfiable: "
                + "./rsc/test/a02.smt2");
        boolean result = testFile("./rsc/test/a02.smt2",
                "./rsc/test/~a02-acker.smt2", "./rsc/test/~a02-unsat.smt2");
    ...
    public void recursiveFunctions() {
        System.out
                .println("****************************************************");
        System.out
                .println("Testcase: 2 different Functions, recursively, valid: "
                        + "./rsc/test/a03.smt2");
        boolean result = testFile("./rsc/test/a03.smt2",
                "./rsc/test/~a03-acker.smt2", "./rsc/test/~a03-unsat.smt2");
        System.out.println("  2 Functions recursively: "
                + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    public void largerRecursiveFunctions() {
        System.out
                .println("****************************************************");
        System.out.println("Testcase: larger recursive functions, valid: "
                + "./rsc/test/a04.smt2");
        boolean result = testFile("./rsc/test/a04.smt2",
                "./rsc/test/~a04-acker.smt2", "./rsc/test/~a04-unsat.smt2");
        System.out.println("  larger recursive functions: "
                + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    public void twoParameters() {
        System.out
                .println("****************************************************");
        System.out.println("Testcase: two Parameters, valid: "
                + "./rsc/test/a05.smt2");
        boolean result = testFile("./rsc/test/a05.smt2",
                "./rsc/test/~a05-acker.smt2", "./rsc/test/~a05-unsat.smt2");
    ...
    public void threeParametersWithInnerFunction() {
        System.out
                .println("****************************************************");
        System.out
                .println("Testcase: three Parameters with inner function, valid: "
                        + "./rsc/test/a06.smt2");
        boolean result = testFile("./rsc/test/a06.smt2",
                "./rsc/test/~a06-acker.smt2", "./rsc/test/~a06-unsat.smt2");
        System.out.println("  three Parameters with inner function: "
                + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    public void functionParameterOrderTest() {
        System.out
                .println("****************************************************");
        System.out
                .println("Testcase: testing correct order of parameters, valid: "
                        + "./rsc/test/a07.smt2");
        boolean result = testFile("./rsc/test/a07.smt2",
                "./rsc/test/~a07-acker.smt2", "./rsc/test/~a07-unsat.smt2");
        System.out.println("  testing correct order of parameters: "
                + (result ? "Success :-)" : "Failed :-("));
        Assert.assertTrue(result);
    }
    ...
    protected boolean testFile(String filename, String outputFileName1,
        ...
        if (state_acker == state_old) {
            System.out.println("  Z3 tells us for before and after: "
                    + state_old + " (1=sat, 2=unsat) ");
        } else {
            System.err.println("  Z3 tells us for before: " + state_old
                    + " and after: " + state_acker + " (1=sat, 2=unsat) ");
        }

        // PropositionalEq equiv = new PropositionalEq(col, false); // false for
        // inequality
